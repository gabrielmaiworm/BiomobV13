...
/**
 * REST controller for managing {@link org.com.biomob.domain.Estoque}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class EstoqueResource {
    ...
    public ResponseEntity<Estoque> updateEstoque(@PathVariable(value = "id", required = false) final Long id, @RequestBody Estoque estoque)
