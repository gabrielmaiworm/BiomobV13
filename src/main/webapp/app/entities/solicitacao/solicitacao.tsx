            ...
            <tbody>
              {solicitacaoList.map((solicitacao, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{solicitacao.nome ? <Link to={`cadastro-user/${solicitacao.nome.id}`}>{solicitacao.nome.id}</Link> : ''}</td>
                  <td>{solicitacao.descricao ? <Link to={`estoque/${solicitacao.descricao.id}`}>{solicitacao.descricao.id}</Link> : ''}</td>
