            ...
            <tbody>
              {acaoList.map((acao, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{acao.dataCriacao ? <TextFormat type="date" value={acao.dataCriacao} format={APP_DATE_FORMAT} /> : null}</td>
                  ...
                  <td>{acao.solicitante ? <Link to={`solicitacao/${acao.solicitante.id}`}>{acao.solicitante.id}</Link> : ''}</td>
