...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './estoque.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ESTOQUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ESTOQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ESTOQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ESTOQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ESTOQUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ESTOQUE actions', async () => {
      const expectedActions = [
        {
